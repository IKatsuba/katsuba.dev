...
You need to start by creating a blank for the package in which we will pack the builders. I generated the workspace using [NX](https://nx.dev/angular), as well as the library blank for the builder.npx create-nx-workspace ng-builders
...
For automation of releases and versioning, [semantic-release](https://github.com/semantic-release/semantic-release) was connected. In the role of CI, Github Actions was used.

I’ll tell you more about the generation of the project, its configuration, and automation in the future since the topic is very large and goes beyond the scope of this article.
...
The builder can NOT be used (as soon as tests appear, I will definitely remove NOT) in your projectsnpm i @ng-builders/build -D
