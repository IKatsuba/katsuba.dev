...
But mergeMap with concreteness 1 does the same thing as concatMap! Literally. This is perfectly visible in the [source code](https://github.com/ReactiveX/rxjs/blob/master/src/internal/operators/concatMap.ts#L60) operator.
...
However, the keyword here is _correct usage_. Always analyze the requirements of your application and choose the right operator carefully. This will help you avoid unwanted side effects and create reactive solutions that can scale and be easily maintained.
