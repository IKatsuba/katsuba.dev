...
Hello everyone! 🌟 This is the first part of [the previously announced series](./micro-frontend-architecture) of posts about an application with a micro-frontend architecture. Not everyone will have the same needs, but I hope everyone will find interesting information 📚.
